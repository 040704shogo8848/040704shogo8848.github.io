...
SK hynixは、この分離が逆向きに現れた例である。2026年第2四半期の売上高は79兆3,187億ウォン、営業利益は60兆5,426億ウォン、営業利益率は76%だった [出典](https://news.skhynix.com/en/q2-2026-business-results/)。前年同期比では売上高が257%増、営業利益が557%増である。それでも7月28日発表の決算は市場予想を5%から6%下回り、株価は下落した。理由は、HBMが年次の長期供給契約で価格を決めているため、汎用DRAMのスポット価格急騰を即座に反映できないことにある。2026年前半には、1ウェハ当たり採算で汎用DRAMがHBMを上回る逆転が生じた [出典](https://xenospectrum.com/sk-hynix-q2-hbm-lta/)。シェアが50%台後半でも、契約の形式が価格決定力を年単位で凍結する。

同じ局面でSamsungとの投資配分が分かれた。SK hynixは2025年の設備投資を当初計画の22兆ウォンから29兆ウォンへ約30%積み増した。2026年のHBM供給について顧客との交渉で需要の見通しを固めたことが理由とされる。HBMの生産能力は2023年の月産3万枚から2024年に10万枚、2025年に17万枚を目標とする拡大である[出典](https://www.trendforce.com/news/2025/07/28/news-sk-hynix-rumored-to-boost-2025-capex-by-30-on-2026-hbm-demand-visibility/)。Samsungは2026年に生産能力を約50%増やす計画で、対象を特定製品に絞った配分を取っている[出典](https://www.datacenterdynamics.com/en/news/samsung-and-sk-hynix-to-scale-up-memory-production-capacity-in-2026-to-meet-ai-demand/)。==分岐点は技術ではなく、需要の見通しをどこまで契約で固めたかにある==。SK hynixは長期契約で数量を確定させてから投資を積み、Samsungは確定していない分を残したまま能力だけを広げた。前者は価格決定力を凍結する代わりに投資判断の確度を得ている。==ここでも、シェアではなく契約と代替性の構造が価格を決めている==。
...
データセンター領域でRISC-Vが有利になる根拠は、性能ではなく2点に整理できる。第1にライセンス構造である。Armは1個あたり販売価格の1%から2%のロイヤリティに加え、数百万ドル単位の前払いライセンス料を取る。年1億個で平均2ドルのロイヤリティなら年2億ドルになる。RISC-VのISAはロイヤリティも前払いもゼロである[出典](https://www.wevolver.com/article/risc-v-vs-arm)。第2にカスタム拡張で、ベクトル長を可変にできる拡張や独自命令をISAの内側に持ち込める。SiFiveのVCIXはこの経路を製品化したものである。==自社設計のアクセラレータを持つ事業者にとって、命令セットの改変権はロイヤリティ削減より重い==。同社は2026年4月にNVIDIAのNVLink Fusionを採用し、RISC-V CPUとNVIDIAアクセラレータの間の一貫性のある高帯域接続を可能にすると発表した[出典](https://www.sifive.com/press/sifive-nvidia-nvlinkfusion-datacenter)。接続規格の側が開いたことが、この領域での実装可能性を変えている。
