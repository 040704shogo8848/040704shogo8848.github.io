...
千葉県印西市がその例である。同市を含む千葉ニュータウンは計画人口に達せず、東京電力が敷いた大規模な送配電網が過剰になった。この余剰がデータセンターを引き寄せた[出典](https://www.itmedia.co.jp/business/articles/2606/22/news018.html)。加えて下総台地は締まった洪積層で、付近に活断層がない[出典](https://www.mc-digitalrealty.com/blog/13)。立地選定では対象地が6万V以上の特別高圧で受電できるかが確認され、近年は海底ケーブル陸揚げ局までの距離も重視される[出典](https://www.scsk.jp/sp/netxdc/column/inzai_datacenter.html)。==印西の優位は、住宅需要の予測が外れたことによって生まれている==。

バージニア州ラウドン郡も同型である。冷戦期の政府による光ファイバ投資が1993年のMAE-East設立につながり、1997年に同郡最初のデータセンターが建った[出典](https://www.pecva.org/region/loudoun/data-centers-in-loudoun-a-primer/)。2008年に州が売上税の免除を導入し、郡が「Data Center Alley」というブランドを立てた。免除の要件は資本投資1.5億ドル超と、平均賃金の1.5倍以上を支払う雇用50人の創出である。この免除の州費用は直近1年で19億ドルに達した[出典](https://www.city-journal.org/article/loudoun-county-virginia-data-centers-construction)。==国防目的で敷かれた回線が、30年後に民間の計算需要の集積を決めている==。
...
- 日本の10エリア別の特別高圧の実効単価を確認できていない。エリア間で立地を動かすほどの差があるかは、各社の料金単価表と託送供給等約款を突き合わせれば判定できる。
...
- 米国以外の通電待ち時間の実測値を確認できていない。日本の特別高圧の新増設について、申込から受電までの期間の統計が一般送配電事業者から公表されているかを当たる必要がある。
- テキサスの監査がいつ終わり、どの条件で接続が再開されるかは2026年8月時点で未定である。8月20日の公益事業委員会の公開会合の結果を追う。
- ラウドン郡の売上税免除について、19億ドルという州費用の算定根拠を一次資料で確認できていない。州の税支出報告書に当たる。
- 印西の送配電網が過剰になった経緯について、千葉ニュータウンの計画人口と実績人口、および東京電力が敷設した設備容量の数値を確認できていない。
- 学習拠点と推論拠点の設備容量の比率を確認できていない。この比率が分かれば、レイテンシ制約を受ける需要が全体のどれだけかを推定できる。
