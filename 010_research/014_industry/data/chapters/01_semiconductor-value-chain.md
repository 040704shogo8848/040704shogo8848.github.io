...
パワー半導体は電流を切り替えて損失を減らす部品である。==用途別の金額内訳も、専業大手のセグメント開示から輪郭は取れる。インフィニオンの2025年9月期の売上は146.62億ユーロで、セグメント利益25.60億ユーロ、利益率17.5% である。同期第3四半期の内訳は車載が18.70億ユーロ、パワー・センサーシステムズが10.53億ユーロ、グリーン産業パワーが4.31億ユーロ、コネクテッドセキュアシステムズが3.69億ユーロだった[出典](https://www.infineon.com/press-release/2025/infxx202511-021)。伸びているのはパワー・センサーシステムズとグリーン産業パワーで、前者はAIサーバー向け電源が牽引している。==車載が最大の区分である一方、成長の起点はデータセンター側に移りつつある。ただしこれは1社のセグメント区分であり、市場全体の用途別金額比ではない。

競争軸は線幅ではなく、耐圧、オン抵抗、熱設計、そして実装である。設備投資の単価も先端ロジックとは1桁以上違う。ロジックとメモリの論理をそのまま持ち込むと読み違える。
...
パワー半導体に限定した工程別シェアの一次データは、本節の時点でも取得できていない。一般のロジック・メモリ工程における日本企業の装置・素材の位置とシェアは、後節「日本の装置・素材はどの工程を握っているか」で扱う。パワー半導体の性能は線幅ではなくパッケージの熱設計で決まる部分が大きく、基板材料、接合材、封止材、モジュール構造の設計がそのまま製品性能になるという構造推論は、モジュール用途別のシェア表が無い以上、依然として推論にとどまる。

## 日本の装置・素材はどの工程を握っているか

結論から述べる。==日本が握っているのは先端ロジックの設計でも露光でもなく、ウェハーとレジストに代表される部素材、および塗布現像・ダイシングといった特定の装置工程である==。国単位では、主要部素材6品目で日本48%、半導体製造装置で日本31%である（as_of: 2021年度実績、OMDIAを経済産業省が再集計） [出典](https://journal.meti.go.jp/wp-content/uploads/2024/03/semiconductors_and_digital_p22.pdf)、[出典](https://www.mof.go.jp/about_mof/councils/fiscal_system_council/sub-of_fiscal_system/proceedings/material/zaiseia20241101/03.pdf)。反対側では、露光装置はASMLが94%、エッチングはLam Researchが37%で首位、検査・計測（プロセスコントロール）はKLAが56.5%を占める。握る工程と握られる工程は同じ価値連鎖の中に同居している。

### 工程別の日本企業の位置とシェア

経済産業省がOmdiaとグローバルネットを基にまとめた工程別シェア（公開は2025年の行政事業レビュー資料。個社シェアの元年次は資料上の表に明記されていない）と、各社IRを突き合わせる [出典](https://www.meti.go.jp/information_2/publicoffer/review2025/kokai/0606_1gaiyo.pdf)。

| 工程 | 主な担い手（国） | シェア | 時点・注記 |
| --- | --- | --- | --- |
| シリコンウェハー | 信越化学29%、SUMCO24%、GlobalWafers（台）19% | 上位2社で53% | 経産省表。信越化学は統合報告書2026で「世界1位」と自己開示 [出典](https://www.shinetsu.co.jp/wp-content/uploads/2026/07/%E7%B5%B1%E5%90%88%E5%A0%B1%E5%91%8A%E6%9B%B82026.pdf) |
| フォトレジスト | 東京応化24%、JSR20%、信越化学18%、DuPont（米）13%ほか | 日本勢上位3社で62% | 経産省表。信越化学は同報告書で「世界2位」と自己開示 |
| レジスト塗布・現像 | 東京エレクトロン89%、SUSS（独）5%、SCREEN3% | TELが首位 | 経産省表。TEL Investors' Guide（CY2025）は91%。**disputed** [出典](https://www.tel.co.jp/ir/library/investors-guide/hq95qj0000000734-att/InvestorsGuide_J20260806_rev01.pdf) |
| EUV用塗布現像 | 東京エレクトロン100% | 同左 | TEL統合報告書2025・Investors' Guideの自己開示 [出典](https://www.tel.co.jp/ir/library/ar/qeguhq00000000i0-att/ir2025_all.pdf) |
| ドライエッチング | Lam（米）37%、TEL26%、AMAT（米）25% | 米2社＋TEL | 経産省表。TELはプラズマエッチングをシェア1位と開示（％は非開示） |
| 露光装置 | ASML（蘭）94%、Canon4%、Nikon2% | オランダ寡占 | 経産省表 |
| ダイシングソー | ディスコ79%、東京精密19% | 日本勢で98% | 経産省表 |
| プロセスコントロール | KLA（米）56.5% | 次点の6.5倍 | KLA Investor Day 2026。**single-source**（10-Kは首位のみ） [出典](https://stockanalysis.com/stocks/klac/transcripts/585329-investor-day-2026/)、[出典](https://www.sec.gov/Archives/edgar/data/319201/000031920125000024/klac-20250630.htm) |

アルバックの位置は真空前提の成膜装置と真空コンポーネントである。Investors' Guide（2026年8月）は2026年6月期売上2,691億円を掲げ、半導体スパッタリング装置のSAM内シェアを19%と自己推計する（Gartner等を基にした当社推計、**estimated / single-source**） [出典](https://ir.ulvac.co.jp/ja/ir/library/InvestorsGuide/main/0/teaserItems1/0/linkList/019/link/%28JP%29InvestorsGuide_2026.8_1.pdf)。半導体用真空ドライポンプの世界シェア％は同資料に無く N/A である。

マクニカは装置でも部素材でもない。工程上の位置は完成チップの高付加価値ディストリビューションである。FY2024の連結売上は1兆342億円、うち半導体事業8,803億円。主要半導体メーカー21社中17社と代理店契約を持ち、デマンドクリエーションを付加価値とする [出典](https://holdings.macnica.co.jp/content/dam/holdings/ir/ja/library/Introduction.pdf)。

### TELの拠点分業（宮城・山梨・熊本）

国内製造は製品カテゴリごとに法人が分かれる [出典](https://www.tel.co.jp/about/locations/)。

| 拠点（法人） | 所在 | 担当工程 |
| --- | --- | --- |
| 東京エレクトロン宮城 | 宮城県黒川郡大和町 | プラズマエッチング |
| 東京エレクトロン テクノロジーソリューションズ | 山梨県（藤井・穂坂ほか） | 熱処理成膜、枚葉成膜、ガスケミカルエッチ、テスト |
| 東京エレクトロン九州 | 熊本県合志市 | コータ／デベロッパ、洗浄、3次元実装 |

採用拠点説明でも同じ分業が繰り返される [出典](https://careers-tel.jp/environment/location/)。Investors' Guideは宮城・山梨・熊本にそれぞれエッチ、成膜、塗布現像／洗浄／ボンディングの開発棟を記す。合志市本社は菊陽町のJASMとは隣接だが別市である（[菊陽の都市プロファイル](https://040704shogo8848.github.io/010_research/013_geo/cities/kikuyo.html)）。

### 九州のシリコンアイランド化の投資額と雇用

九州経済調査協会の2024年12月更新では、2021〜2030年の九州・沖縄・山口の半導体関連設備投資（1億円超、201件）は総額6兆1,820億円、経済波及効果は23兆300億円である [出典](https://www.jetro.go.jp/biznews/2025/01/bde05bc48dd636b3.html)。前年は投資約6.0兆円・波及20兆770億円だった [出典](https://www.kerc.or.jp/sp/prs/20231225sem.pdf)。波及の県別では熊本が13兆3,890億円で過半を占める。

九州経済産業局「九州経済の現状2024」では、2024年の九州IC生産金額は1兆3,126億円、全国比48.5%である（出所: 生産動態統計） [出典](https://www.kyushu.meti.go.jp/keiki/chosa/genjyo/kyushu-genjo_2024.pdf)。日銀福岡支店の整理では、それ以前は約4割（例: 9,301億円で44.3%）だった [出典](https://www3.boj.or.jp/fukuoka/topics/topics202303.pdf)。

雇用は層が分かれる。工業統計ベースの半導体関連製造業従業者は2019年に九州35,939人（全国比23.4%）である [出典](https://www.s-kumamoto.jp/2022result/event/no17.pdf)、[出典](https://www3.boj.or.jp/fukuoka/topics/topics202303.pdf)。JASMは第1・第2工場合計で投資2兆9,600億円超、雇用予定3,400人以上（熊本県資料、as_of: 2024年5月） [出典](https://www.chisou.go.jp/tiiki/kokusentoc_wg/r6/pdf/20240517_shiryou_3.pdf)。第1工場のみ約1,700人という別掲もあり **disputed**。九州全体の2024〜2025年就業者総数は未取得で N/A である。

### 依存の非対称

並べると非対称は明確である。日本が過半近くを握るのはウェハーとレジストと塗布現像とダイシングであり、国単位でも部素材48%・装置31%という厚みがある。一方で、線幅を決める露光はASMLに94%依存し、エッチングはLamが首位、歩留まりを決める検査・計測はKLAが56.5%を占める。アルバックの真空ポンプ世界シェアは開示がなく、マクニカは装置工程の外側にいる。==握っている工程は川上の素材と特定装置であり、握られている工程は露光とプロセスコントロールである==。九州の再投資は、この非対称の上にロジック製造拠点を足す動きであって、露光や検査の国別シェアそのものをひっくり返してはいない。
...
- 日本が握るのはウェハー・レジスト・塗布現像・ダイシングであり、国単位では部素材48%・装置31%（2021年度）。握られるのは露光（ASML 94%）とプロセスコントロール（KLA 56.5%）である。
- TELの国内製造は宮城＝エッチ、山梨＝成膜・ガスケミカル、熊本＝塗布現像・洗浄・3次元実装に分かれる。
- 九州の半導体関連設備投資は2021〜2030年で6兆1,820億円（201件）。2024年の九州IC生産金額は1兆3,126億円、全国比48.5%である。
...
- 後工程投資の回収年数を明示した一次開示が見つからない。ASEの2026年上期の設備投資は機械装置27億ドル、建屋と自動化14億ドル、減価償却は674億台湾ドルという規模までは確認したが、資産区分ごとの見積耐用年数の開示に到達していない。OSATの機械装置の耐用年数、装置1台あたりの取得価額、稼働率前提の3点が揃えば下限は計算できる。AmkorのForm 10-KとASEの年次報告書の有形固定資産注記が必要である。
- パワー半導体市場の用途別金額内訳を市場全体として取得できていない。インフィニオン1社のセグメント別売上は確認したが、区分が用途と一致せず、車載とデータセンターの金額比と1台あたり搭載額は依然として未確認である。YoleまたはOmdiaのパワーデバイス市場レポート、InfineonとSTMicroelectronicsの用途別売上開示が必要になる。
- 日本勢がパワー半導体のどの工程で相対優位を持つかは、本章の「日本の装置・素材はどの工程を握っているか」で確認した一般工程の装置・素材シェアとは別に、依然として構造推論にとどまる。Yoleのパワーモジュール市場シェア表と、SiC／GaNウエハー・モジュール工程の品目別シェアが要る。
